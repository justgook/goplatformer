...
type Collision[T comparable] struct {
	checkingObject *Object[T]   // The checking object
	dx, dy         float64      // The delta the checking object was moving on that caused this collision
	Objects        []*Object[T] // Slice of objects that were collided with; sorted according to distance to calling
	// Object.
	Cells []*Cell[T] // Slice of cells that were collided with; sorted according to distance to calling
	// Object.
}

func NewCollision[T comparable]() *Collision[T] {
	return &Collision[T]{
		Objects: []*Object[T]{},
	}
}
...
func (cc *Collision[T]) HasTags(tags ...T) bool {
...
func (cc *Collision[T]) ObjectsByTags(tags ...T) []*Object[T] {
...
func (cc *Collision[T]) ContactWithObject(object *Object[T]) vector.Vector {
...
func (cc *Collision[T]) ContactWithCell(cell *Cell[T]) vector.Vector {
	delta := vector.Vector{0, 0}
...
func (cc *Collision[T]) SlideAgainstCell(cell *Cell[T], avoidTags ...T) vector.Vector {
